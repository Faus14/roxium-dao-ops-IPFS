...
import type { TaskPayloadV1 } from "../types/arkiv-domain.js";

export async function createTaskOnArkiv(input: TaskPayloadV1) {
  ...
  const { entityKey, txHash } = await walletClient.createEntity({
    ...
    attributes: [
      { key: "type", value: "task" },
      { key: "proposalKey", value: input.proposalKey },
